...
export class productService {
  ...
  newProduct(product: products): Observable < products > {
    return this.http.post < products > (this.apiUrl, product, this.httpOptions);
  }
  updateProduct(productId: number, product: products): Observable < products > {
    return this.http.put < products > (`${this.apiUrl}/${productId}`, product, this.httpOptions);
  }
