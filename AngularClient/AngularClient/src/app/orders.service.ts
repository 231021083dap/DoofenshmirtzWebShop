...
export class OrdersService {
  ...
  newOrders(order: Orders): Observable < Orders > {
    return this.http.post < Orders > (this.apiUrl, order, this.httpOptions)
  };
  updateOrders(orderID: number, order: Orders): Observable < Orders > {
    return this.http.put < Orders > (`${this.apiUrl}/${orderID}`, order, this.httpOptions)
  };
